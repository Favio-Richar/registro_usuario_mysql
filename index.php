                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="nombre2" id="nombre2" placeholder="Digite segundo Nombre" required>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="apellido2" id="apellido2" placeholder="Digite segundo Apellido" required>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="documento">Numero de Documento</label>
                                                        <input type="text" class="form-control" name="documento" id="documento" placeholder="Digite Numero de Documento" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
